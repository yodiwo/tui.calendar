...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
      ...
      function Ii() {
        ...
        var Vo = jc, jo = Xc, hl = Kc, gl = qc, vl = Jc, xi = Qc, Xo = Zc, ve = null, Ri = j({}, [].concat(s(Et), s(ue), s(Ue), s(lt), s(Rt))), we = null, Oi = j({}, [].concat(s(Ot), s(ut), s(Pt), s($n))), pe = Object.seal(Object.create(null, {
        ...
        })), gn = null, Ko = null, Pi = !0, qo = !0, Li = !1, Ht = !1, Dt = !1, Zo = !1, Jo = !1, $t = !1, Fn = !1, Un = !1, Hi = !0, Qo = !0, vn = !1, Bt = {}, Gt = null, $i = j({}, ["annotation-xml", "audio", "colgroup", "desc", "foreignobject", "head", "iframe", "math", "mi", "mn", "mo", "ms", "mtext", "noembed", "noframes", "noscript", "plaintext", "script", "style", "svg", "template", "thead", "title", "video", "xmp"]), Bi = null, Gi = j({}, ["audio", "video", "img", "source", "image", "track"]), er = null, Fi = j({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns"]), tr = "http://www.w3.org/1998/Math/MathML", nr = "http://www.w3.org/2000/svg", mt = "http://www.w3.org/1999/xhtml", zn = mt, or = !1, Ft, _l = ["application/xhtml+xml", "text/html"], yl = "text/html", St, Ut = null, wl = Z.createElement("form"), Ui = function(g) {
          ...
          Ut && Ut === g || ((!g || n(g) !== "object") && (g = {}), g = de(g), ve = "ALLOWED_TAGS" in g ? j({}, g.ALLOWED_TAGS) : Ri, we = "ALLOWED_ATTR" in g ? j({}, g.ALLOWED_ATTR) : Oi, er = "ADD_URI_SAFE_ATTR" in g ? j(de(Fi), g.ADD_URI_SAFE_ATTR) : Fi, Bi = "ADD_DATA_URI_TAGS" in g ? j(de(Gi), g.ADD_DATA_URI_TAGS) : Gi, Gt = "FORBID_CONTENTS" in g ? j({}, g.FORBID_CONTENTS) : $i, gn = "FORBID_TAGS" in g ? j({}, g.FORBID_TAGS) : {}, Ko = "FORBID_ATTR" in g ? j({}, g.FORBID_ATTR) : {}, Bt = "USE_PROFILES" in g ? g.USE_PROFILES : !1, Pi = g.ALLOW_ARIA_ATTR !== !1, qo = g.ALLOW_DATA_ATTR !== !1, Li = g.ALLOW_UNKNOWN_PROTOCOLS || !1, Ht = g.SAFE_FOR_TEMPLATES || !1, Dt = g.WHOLE_DOCUMENT || !1, $t = g.RETURN_DOM || !1, Fn = g.RETURN_DOM_FRAGMENT || !1, Un = g.RETURN_TRUSTED_TYPE || !1, Jo = g.FORCE_BODY || !1, Hi = g.SANITIZE_DOM !== !1, Qo = g.KEEP_CONTENT !== !1, vn = g.IN_PLACE || !1, Xo = g.ALLOWED_URI_REGEXP || Xo, zn = g.NAMESPACE || mt, g.CUSTOM_ELEMENT_HANDLING && Ui(g.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (pe.tagNameCheck = g.CUSTOM_ELEMENT_HANDLING.tagNameCheck), g.CUSTOM_ELEMENT_HANDLING && Ui(g.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (pe.attributeNameCheck = g.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), g.CUSTOM_ELEMENT_HANDLING && typeof g.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements == "boolean" && (pe.allowCustomizedBuiltInElements = g.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), Ft = _l.indexOf(g.PARSER_MEDIA_TYPE) === -1 ? Ft = yl : Ft = g.PARSER_MEDIA_TYPE, St = Ft === "application/xhtml+xml" ? function(C) {
            return C;
          } : $, Ht && (qo = !1), Fn && ($t = !0), Bt && (ve = j({}, s(Rt)), we = [], Bt.html === !0 && (j(ve, Et), j(we, Ot)), Bt.svg === !0 && (j(ve, ue), j(we, ut), j(we, $n)), Bt.svgFilters === !0 && (j(ve, Ue), j(we, ut), j(we, $n)), Bt.mathMl === !0 && (j(ve, lt), j(we, Pt), j(we, $n))), g.ADD_TAGS && (ve === Ri && (ve = de(ve)), j(ve, g.ADD_TAGS)), g.ADD_ATTR && (we === Oi && (we = de(we)), j(we, g.ADD_ATTR)), g.ADD_URI_SAFE_ATTR && j(er, g.ADD_URI_SAFE_ATTR), g.FORBID_CONTENTS && (Gt === $i && (Gt = de(Gt)), j(Gt, g.FORBID_CONTENTS)), Qo && (ve["#text"] = !0), Dt && j(ve, ["html", "head", "body"]), ve.table && (j(ve, ["tbody"]), delete gn.tbody), E && E(g), Ut = g);
...
function en(e, { onInit: t, onDragStart: n, onDrag: o, onMouseUp: r, onPressESCKey: i } = {}) {
  ...
  const [p, h] = ae(!1), m = ne(null), _ = ne(null), y = ne(null), E = ee(
    ...
    (T) => {
      tp(T, _c.ESCAPE) && (h(!1), l(), i == null || i(T, f.current));
    },
    [i, l]
  );
  return re(() => {
...
function Ec({
  ...
  const { isReadOnly: a } = W(je), l = se(Xa), [u, c] = Ge(), { narrowWeekend: f = !1, startDayOfWeek: p = rn.SUN } = o, h = z(() => Math.max(0, ...e.map(({ top: N }) => N)), [e]), m = z(
    () => hi({
      container: u,
      rowsCount: 1,
...
function Ap() {
  const { useFormPopup: e } = W(je), t = W(kp), { event: n, eventRect: o } = t != null ? t : {}, { showFormPopup: r, hideDetailPopup: i } = Te("popup"), s = yi(n), a = xt(), l = Di("detailPopupSlot"), u = Ne(), c = ne(null), [f, p] = ae({}), [h, m] = ae(0), [_, y] = ae(
    Yt.left
  ), E = z(() => {
  ...
  if (ht(() => {
    if (c.current && o && a) {
      const te = a.getBoundingClientRect(), b = c.current.getBoundingClientRect(), [D, V] = Ip(o, te, b), { top: J, direction: ge } = Mp(
        o,
        te,
        b
      );
...
function Xp() {
  var X;
  const { calendars: e } = W(Lo), { hideAllPopup: t } = Te("popup"), n = W(Cp), { start: o, end: r, popupArrowPointPosition: i, close: s, isCreationPopup: a, event: l } = n != null ? n : {}, u = Ne(), c = Di("formPopupSlot"), [f, p] = Pp((X = e[0]) == null ? void 0 : X.id), h = ne(null), m = ne(null), [_, y] = ae({}), [E, w] = ae(0), [S, k] = ae(
    Vt.bottom
  ), T = xt(), N = z(() => {
  ...
  if (ht(() => {
    if (m.current && i && T) {
      const I = T.getBoundingClientRect(), $ = m.current.getBoundingClientRect(), { top: R, left: q, direction: te } = Yp(
        i,
        I,
        $
      ), b = i.left - q;
...
function im({
  ...
  const {
    ...
    croppedStart: m,
    croppedEnd: _
  } = e, y = "white", E = 2, w = 2, S = om(s), { color: k, backgroundColor: T, borderColor: N, dragBackgroundColor: F } = ba(
    e,
    o
  ), X = {
    width: rm(c || l, S),
...
function Ti({
  ...
  const {
    ...
    isReadOnly: i,
    week: s
  } = W(je), a = yi(e.model), { collapseDuplicateEvents: l } = s, u = xt(), { showDetailPopup: c } = Te("popup"), { setDraggingEventUIModel: f } = Te("dnd"), { setSelectedDuplicateEventCid: p } = Te("weekViewLayout"), h = Ne(), m = ne(null), [_, y] = ae(!1), { model: E, goingDurationHeight: w, modelDurationHeight: S, comingDurationHeight: k, croppedEnd: T } = e, { id: N, calendarId: F, customStyle: X } = E, I = L(t), { containerStyle: $, goingDurationStyle: R, modelDurationStyle: q, comingDurationStyle: te } = im(
...
function Em({
  ...
  const n = W(ym), o = W(wm), r = Ne(), { isDraggingEnd: i, isDraggingCanceled: s, draggingEvent: a, clearDraggingEvent: l } = fn(
    "timeGrid",
    "move"
  ), [u, c] = dn(e), f = ne(null);
  re(() => {
...
function Pc({ timeGridData: e, events: t }) {
  ...
  ), [, u] = Bo(), c = Fm(), { width: f } = se(li), [p, h] = ae(null), { columns: m, rows: _ } = e, y = m.length - 1, E = z(
    () => m.map(
...
function sh({ date: e, events: t = [], style: n, parentContainer: o, contentAreaHeight: r }) {
  const i = xt(), { showSeeMorePopup: s } = Te("popup"), a = se(ih), { popupPosition: l, containerRefCallback: u } = rh(
    t.length,
    o,
    i
  ), c = ee(() => {
...
function gh({ dateMatrix: e = [], rowInfo: t = [], cellWidthMap: n = [] }) {
  const [o, r] = Ge(), i = W(Lo), { ref: s, cellContentAreaHeight: a } = hh(Zt), { eventFilter: l, month: u, isReadOnly: c } = W(je), { narrowWeekend: f, startDayOfWeek: p } = u, h = mh / e.length, m = z(
    () => hi({
      container: o,
      rowsCount: e.length,
...
function Fc() {
  const e = W(je), { renderDate: t } = W(cn), n = vh(e), o = e.month, { narrowWeekend: r, startDayOfWeek: i, workweek: s } = o, a = z(
    () => lc(t, o),
    [o, t]
...
class Uo {
  constructor(t, n = {}) {
    ...
    B(this, "store");
    var o;
    this.container = Ce(t) ? (o = document == null ? void 0 : document.querySelector(t)) != null ? o : null : t, this.theme = qd(n.theme), this.eventBus = new ig(), this.store = Id(n), this.renderRange = this.calculateRenderRange(he()), Ad(), this.getStoreState().options.usageStatistics === !0 && Lh("calendar", Hh);
  }
  getStoreState(t) {
